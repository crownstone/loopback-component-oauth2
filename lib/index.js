  ...
  return function oauth2AuthenticateHandler(req, res, next) {
    ...
    if (accessToken.length > 32) {
      ...
      return router(req, res, (err, result) => {
        ...
        // We use the oauth scopes in our code for Hooks, but we do not want to interfere with the loopback ACL scopes. We rename the field for
        // custom use and clear the .scopes.
        req.accessToken.oauthScopes = req.accessToken.scopes
